  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: "50%",
        background:
          "conic-gradient(from 210deg, #2a2d36, #14151a 60%, #2a2d36)",
    ...
    >
      ...
      <span
        style={{
          ...
          boxShadow: "0 0 8px var(--radio-amber)",
        }}
      />
      <span
        ...
        style={{
          ...
          textShadow:
            "0 0 10px color-mix(in srgb, var(--radio-amber) 40%, transparent)",
        }}
      >
        42.0
      </span>
