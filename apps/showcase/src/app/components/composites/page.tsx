...
export default function CompositesPage() {
  return (
    <div className="mx-auto max-w-4xl space-y-8">
      <PageHeader title="Composites" description="PageHeader, EmptyState and StatCard." />
      ...
      <Demo title="StatCard" className="flex-col items-stretch">
        <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-3">
          <StatCard title="Revenue" value="$45,231.89" delta={{ value: "+20.1%", direction: "up" }} />
          <StatCard title="Subscriptions" value="2,350" delta={{ value: "-4.5%", direction: "down" }} />
          <StatCard title="Active Now" value="573" delta={{ value: "0%", direction: "flat" }} />
        </div>
      </Demo>
    </div>
  )
