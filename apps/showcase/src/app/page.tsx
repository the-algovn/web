...
const sections = [
  {
    ...
    blurb: "Variants, sizes, states",
  },
  {
    title: "Inputs",
    href: "/components/inputs",
    blurb: "Text, select, date, combobox",
  },
  {
    title: "Overlays",
    href: "/components/overlays",
    blurb: "Dialogs, sheets, menus",
  },
  {
    title: "Navigation",
    href: "/components/navigation",
    blurb: "Tabs, breadcrumbs, pagination",
  },
  {
    title: "Data Display",
    href: "/components/data-display",
    blurb: "Cards, tables, accordions",
  },
  {
    title: "Feedback",
    href: "/components/feedback",
    blurb: "Alerts, toasts, progress",
  },
  {
    title: "Composites",
    href: "/components/composites",
    blurb: "PageHeader, EmptyState, StatCard",
  },
  { title: "Forms", href: "/patterns/forms", blurb: "RHF + zod recipes" },
  {
    title: "Charts",
    href: "/patterns/charts",
    blurb: "Line, area, bar, pie, radial",
  },
  {
    title: "Data Table",
    href: "/patterns/data-table",
    blurb: "Sort, filter, paginate",
  },
]
    ...
    <div className="mx-auto max-w-5xl">
      ...
      <div className="grid gap-4 pb-8 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          value="50+"
          icon={<Cpu />}
          delta={{ value: "all vendored", direction: "flat" }}
        />
        <StatCard
          title="P&L"
          value="$12,430"
